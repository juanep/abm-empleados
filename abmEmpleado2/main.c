...
void mostrarEmpleadoXsector(eEmpleado lista[], int tam, eSector sectores[], int tamSector);
...
void altaEmpleado(eEmpleado lista[], int tam, eSector sectores[], int tamSector){
    int indice, legajo, existe, idSector;
...
void mostrarEmpleadoXsector(eEmpleado lista[], int tam, eSector sectores[], int tamSector){
    int auxSector, control;
    listarSectores(sectores, tamSector);
    printf("\nIngrese sector: ");
    control = scanf("%d", &auxSector);
    if(control < 1 || control > 5){
        printf("Error, ingrese un sector del listado.");
    }
    else{
        system("cls");
        printf(" *** Listado de Empleados X Sector *** \n\n");
        printf("Legajo   Nombre  Sexo   Sueldo  Sector\n\n");
        for(int i=0; i<tam; i++){
            if(lista[i].idSector == auxSector){
